...
/* IoTConnect client override for Azure user names */
#define MQTT_USERNAME_MAX_LEN			256
/// Max length of password for log-in
#define MQTT_PASSWORD_MAX_LEN			160
/// Max length of client ID
/* IoTConnect client override for AWS/Azure Client ID */
#define MQTT_CLIENT_ID_MAX_LEN			128
