...
int iotc_platform_acquire_config_values(IotConnectClientConfig *c) {
    ...
    {
        IOTC_ERROR("platform_get_iotconnect_auth_type() failed\n");
        goto cleanup;
    }
    ...
    if(c->auth_info.type == IOTC_AT_SYMMETRIC_KEY)
    {
        ...
        {
            IOTC_ERROR("platform_get_iotconnect_symmetric_key() failed\n");
            goto cleanup;
        }
