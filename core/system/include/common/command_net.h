...
#if defined (__SUPPORT_IOTCONNECT_FOR_ATCMD__) || defined (__SUPPORT_IOTCONNECT_FOR_CLI__)
extern void cmd_network_iotconnect_demo(int argc, char *argv[]);
#endif
...
int cert_flash_write(int flash_addr, char *start_addr, size_t len);
