...
void cmd_iotconnect_config(int argc, char *argv[])
{
    ...
    if (argc == 1) {
        ...
        PRINTF("  Usage : iotconnect_config [reset|env|cpid|duid|symmetric_key|auth_type|use_cmd_ack|use_ota_ack] [value]\n");
...
usage:
    PRINTF("iotconnect_config\n\n");
    PRINTF("  Usage : iotconnect_config [env|cpid|duid|symmetric_key|auth_type|use_cmd_ack|use_ota_ack] [value]\n");
}
...
usage:
    ...
    PRINTF("  Usage : iotconnect_client start\n");
    PRINTF("          iotconnect_client stop\n");
