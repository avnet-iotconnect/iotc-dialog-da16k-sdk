...
const user_conf_str user_config_str_with_nvram_name[] = {
  ...
  { DA16X_CONF_STR_IOTCONNECT_SYNC_MODE,     "IOTC_SYNC_MODE", 8},
  { DA16X_CONF_STR_IOTCONNECT_USE_CMDACK,  "IOTC_USE_CMDACK", 8},
  { DA16X_CONF_STR_IOTCONNECT_USE_OTAACK,  "IOTC_USE_OTAACK", 8},

//  { DA16X_CONF_STR_IOTCONNECT_DISCOVERY_HOST, "IOTC_DISCOVERY_HOST", 256},
  { DA16X_CONF_STR_IOTCONNECT_CPID,          "IOTC_CPID", 64},
  { DA16X_CONF_STR_IOTCONNECT_ENV,           "IOTC_ENV",  64},
  { DA16X_CONF_STR_IOTCONNECT_DUID,          "IOTC_DUID",  64},

  { DA16X_CONF_STR_IOTCONNECT_AUTH_TYPE,     "IOTC_AUTH_TYPE", 8},
  { DA16X_CONF_STR_IOTCONNECT_SYMMETRIC_KEY, "IOTC_SYMMETRIC_KEY", 256},

  { DA16X_CONF_STR_IOTCONNECT_DTG,           "IOTC_DTG", 64},
