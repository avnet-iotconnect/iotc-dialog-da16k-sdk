...
typedef enum {
    ...
    DA16X_CONF_STR_IOTCONNECT_SYNC_MODE,
    DA16X_CONF_STR_IOTCONNECT_USE_CMD_ACK,
    DA16X_CONF_STR_IOTCONNECT_USE_OTA_ACK,

//    DA16X_CONF_STR_IOTCONNECT_DISCOVERY_HOST,
    DA16X_CONF_STR_IOTCONNECT_CPID,
    DA16X_CONF_STR_IOTCONNECT_ENV,
    DA16X_CONF_STR_IOTCONNECT_DUID,

    DA16X_CONF_STR_IOTCONNECT_AUTH_TYPE,
    DA16X_CONF_STR_IOTCONNECT_SYMMETRIC_KEY,

    DA16X_CONF_STR_IOTCONNECT_DTG,
