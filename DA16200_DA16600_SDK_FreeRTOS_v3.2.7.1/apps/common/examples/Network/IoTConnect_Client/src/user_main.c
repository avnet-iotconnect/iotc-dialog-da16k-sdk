...
int config_pin_mux(void)
{
    ...
    /* DA16600 default pin-configuration */
    ...
    #error "Please check and add correct pin mux configuration for your H/W ... "
#else
...
#endif // defined (__ATCMD_IF_UART2__) || defined (__SUPPORT_UART2__)
