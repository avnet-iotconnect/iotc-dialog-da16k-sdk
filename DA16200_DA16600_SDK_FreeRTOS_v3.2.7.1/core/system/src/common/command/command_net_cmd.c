...
const COMMAND_TREE_TYPE	cmd_net_list[] = {
  ...
  { "cli",				CMD_FUNC_NODE,	NULL,	&cmd_da16x_cli,			"cli help"														},
...
#if 1
  { "iotconnect_config",	CMD_FUNC_NODE,  NULL,   &cmd_iotconnect_config,		"iotconnect_config [env|cpid|duid|symmetric_key|auth_type|use_cmd_ack|use_ota_ack] [value]"						},
  { "iotconnect_client",	CMD_FUNC_NODE,  NULL,   &cmd_iotconnect_client,		"iotconnect_client [start|stop|msg|cmd_ack|ota_ack]"						},
#endif
